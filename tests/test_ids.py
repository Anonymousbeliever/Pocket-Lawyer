...
def test_point_id_is_deterministic():
    first = point_id("constitution-of-kenya-2010@v2010-chapter-four-article-49")
    second = point_id("constitution-of-kenya-2010@v2010-chapter-four-article-49")
...
def test_different_chunks_get_different_ids():
    ids = {
        point_id(f"constitution-of-kenya-2010@v2010-chapter-four-article-{n}")
...
def test_documents_do_not_collide():
    ...
    constitution = point_id("constitution-of-kenya-2010@v2010-article-1")
